...
async def _ensure_db():
    ...
    async with factory() as db:
        ...
        await _grant(db, login_role, perm_cache, Perm.TICKET_MAKE, "all")
        ...
        await _grant(db, coordinator_role, perm_cache, Perm.STATION_MAKE, "all")
        ...
        await _grant(db, coordinator_role, perm_cache, Perm.MAP_MAKE, "all")
        ...
        await _grant(db, coordinator_role, perm_cache, Perm.TICKET_MAKE, "all")
