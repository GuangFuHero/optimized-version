...
user/team/work_zone/audit/rbac/announcement/pre_departure) are actually granted below; the
rest of the Perm catalog (ticket.export/ai_duplicate) is registered as a Permission row so
