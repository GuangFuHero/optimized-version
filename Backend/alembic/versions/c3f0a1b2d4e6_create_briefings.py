...
Re-parented onto c7d8e9f0a1b2 (the rbac+announcement merge head on main) when the briefings
feature was rebuilt onto post-RBAC main, so it extends the single head instead of forking off
the old announcement head a7c9e1f4b2d8.
"""
