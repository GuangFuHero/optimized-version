...
> **GraphQL API Design**: See [Spec/Docs/graphql-api-design.md](../../../_shared/engineering/graphql-api-design.md) for the complete GraphQL schema design including queries, mutations, RBAC mappings, business rules, and test plan.
