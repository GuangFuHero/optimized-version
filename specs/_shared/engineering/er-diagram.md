...
**Status:** cross-area structural reference; partially verified, not runtime validation

**Verification snapshot:** Compared with current SQLAlchemy model/table names and Alembic files at code commit `44ce18f5836ee3e0a753240983932a865723cb54` on 2026-08-02. The diagram includes the observed identity, policy, geometry, station, task, assignment, suggestion, and property-configuration structures. It has not been compared with a live migrated database, constraints may be described more strongly than the ORM enforces, and it must not be used as proof that product behavior is Released.
