...
**文件參考**: `specs/_shared/engineering/rbac-permissions-design.md`
...
3. 創建 `specs/_shared/engineering/api-contracts.md` 記錄 GeoJSON 格式
...
- [x] **權限系統設計**: 定義所有權限和預設角色 → _完成_ (見 `specs/_shared/engineering/rbac-permissions-design.md`)
...
- [ ] **創建 API contracts 文件**: `specs/_shared/engineering/api-contracts.md` → _指派給:_ \***\*\_\_\_\*\***
...
- ✅ 已完成權限系統設計文件 (`specs/_shared/engineering/rbac-permissions-design.md`)
