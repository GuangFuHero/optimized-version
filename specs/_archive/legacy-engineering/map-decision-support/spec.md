...
- **FR-083**: The GraphQL API schema, operations, RBAC mappings, and business rules (ticket status state machine, geometry type validation, soft-delete visibility, crowdsourcing vote upsert) are defined in [Spec/Docs/graphql-api-design.md](../../../_shared/engineering/graphql-api-design.md).
