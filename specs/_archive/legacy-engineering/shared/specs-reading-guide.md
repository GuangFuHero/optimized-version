...
**完整規格**: `specs/v1.0.0/06-map-decision-support/engineering/spec.md`
...
**完整規格**: `specs/v1.0.0/08-ticket-management/engineering/request-management/spec.md`
...
**完整規格**: `specs/v1.0.0/08-ticket-management/engineering/volunteer-dispatch/spec.md`
...
**完整規格**: `specs/v1.0.0/07-resource-station/engineering/spec.md`
...
**完整規格**: `specs/v1.0.0/05-member-management/engineering/spec.md`
...
**完整規格**: `specs/v1.0.0/09-emergency-announcement/engineering/spec.md`
...
```bash
# 查看某個 feature 的完整規格
cat specs/v1.0.0/06-map-decision-support/engineering/spec.md
cat specs/v1.0.0/08-ticket-management/engineering/request-management/spec.md
cat specs/v1.0.0/08-ticket-management/engineering/volunteer-dispatch/spec.md
cat specs/v1.0.0/07-resource-station/engineering/spec.md
cat specs/v1.0.0/05-member-management/engineering/spec.md
cat specs/v1.0.0/09-emergency-announcement/engineering/spec.md

# 查看整合文件
cat specs/_shared/engineering/feature-integration-discussion.md
cat specs/_shared/engineering/rbac-permissions-design.md
cat specs/_shared/engineering/feature-dependency-analysis.md
```
...
```bash
# 搜尋特定功能需求
grep "FR-" specs/*/*/engineering/*/spec.md

# 搜尋整合點
grep -i "integration" specs/*/*/engineering/*/spec.md

# 搜尋依賴關係
grep -i "depend" specs/*/*/engineering/*/spec.md
```
