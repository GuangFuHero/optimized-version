...
> **日期**：2026-06-10
> **關聯**：[[../prd]]（05-member-management）、[[../../01-auth/prd]]、[[../../04-rbac/prd]]、[[../../03-user-settings/prd]]
...
> 🟡 **建議：強制 OTP**（與 05 傾向一致）。流程：掃 QR → 填手機 → 收 OTP → 完成註冊。OTP 規格沿用 [[../../01-auth/prd]] 研究（6 碼 / 5 分鐘 / 限流）。
...
- 與本 repo 既有：[[../../01-auth/prd]]（OTP 規格）、[[guest-restricted-access-patterns]]（訪客模型）
